...
const HomeLayout = () => {
 ...
 return (
  <>
   <div style={backgroundImageStyle} className='flex flex-col mobile:hidden'>
    <Header2 onGetHeight={getHeightHeader} />
    <div className='flex-1 grid grid-cols-4 ipad:grid-cols-3 tablet:grid-cols-3'>
     <div
      style={sidebarStyles}
     ...
     <div
      style={sidebarStyles}
      className='col-span-3 ipad:col-span-3 tablet:col-span-2 p-5'
     >
      <Outlet />
     </div>
    </div>
