    ...
    <div className="text-[22px] h-screen w-screen bg-gray-100 flex items-center">
      <div className="container flex flex-col items-center justify-center px-5 text-gray-700 md:flex-row">
        <div className="max-w-md">
          ...
          <p className="text-2xl font-light leading-normal md:text-5xl md:my-5">
          ...
          <Link
            to="/"
            className="inline px-4 py-2 text-sm text-2xl font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg shadow focus:outline-none focus:shadow-outline-blue active:bg-blue-600 hover:bg-blue-700"
          >
            Back to homepage
          </Link>
        </div>
